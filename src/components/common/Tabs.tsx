...
const TabContext = createContext({activeTab : 0, setActiveTab : (_ : number) => {},});
...
export function Tab({children, index} : PropsWithChildren<{index : number}>){
	...
	return (
		<button className=
		{cn("border-b-3 p-14","",{"text-main border-main":activeTab === index, "border-transparent text-gray-500" : activeTab !== index})} 
